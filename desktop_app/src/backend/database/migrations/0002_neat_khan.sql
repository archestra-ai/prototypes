...
INSERT INTO `__new_user`("id", "has_completed_onboarding", "collect_telemetry_data", "created_at", "updated_at") SELECT "id", "has_completed_onboarding", "collect_telemetry_data", "created_at", "updated_at" FROM `user`;--> statement-breakpoint
